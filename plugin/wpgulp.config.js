...
module.exports = {
  ...
  // Project options.
  projectURL: 'wordpress_vipgo.staging.entravision.com', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
  productURL: './', // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
  browserAutoOpen: false,
  injectChanges: true,

  // Style options.
  styleSRC: './assets/src/scss/index.scss', // Path to main .scss file.
  ...
  // Watch files paths.
  watchStyles: './assets/src/scss/**/*.scss', // Path to all *.scss files
  watchJsVendor: './assets/src/vendor/src/js/*.js', // Path to all vendor JS files.
  watchJsCustom: './assets/src/js/**/*.js', // Path to all custom JS files.
  watchPhp: './**/*.php', // Path to all PHP files.

  // Translation options
  textDomain: 'NOTICIASYA', // Your textdomain here.
  translationFile: 'NOTICIASYA.pot', // Name of the translation file.
  translationDestination: './languages', // Where to save the translation files.
  packageName: 'NOTICIASYA', // Package name.
  bugReport: 'ithelp@designcollective.io', // Where can users report bugs.
  lastTranslator: '', // Last translator Email ID.
  team: 'DesignCollective.io', // Team's Email ID.

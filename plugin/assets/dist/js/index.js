...
},{"../modules":4,"./page":2,"gsap/CSSPlugin":8,"slick-carousel":20}],2:[function(require,module,exports){
"use strict";
...
var FastClick = require('fastclick'); // import scrollClass from './scrollClass';
...
console.log('page:', page); // Main blocks
...
page.calcNavHeight = function () {
  ...
  var ah = page.announcementBar.outerHeight();
  var calcHeight = nh;
...
var scrollToClear = page.calcNavHeight();
...
var scroll_pos = 0;
var scroll_time; // NOTE:  Simple Navbar Scroll

(0, _jquery["default"])(window).scroll(function () {
  clearTimeout(scroll_time);
  var current_scroll = (0, _jquery["default"])(window).scrollTop();
  ...
  scroll_time = setTimeout(function () {
    scroll_pos = (0, _jquery["default"])(window).scrollTop();
  }, 100);
}); // Scroller
...
page.skroller.on('click', function () {
  ...
  (0, _jquery["default"])('html, body').animate({
    scrollTop: (0, _jquery["default"])('#hero_end').offset().top - scroll_offset
  }, 1000);
}); // Loader
...
},{"fastclick":7,"gsap/TweenLite":9,"jquery":10,"mobile-detect":19,"ua-parser-js":21,"wowjs":22}],3:[function(require,module,exports){
"use strict";
...
srcHelloWorld(); // Attach to Window  (Global)
...
(0, _jquery["default"])(function () {
  ...
  */
  ...
  require('bootstrap-sass/assets/javascripts/bootstrap/dropdown'); // require("bootstrap-sass/assets/javascripts/bootstrap/popover");
...
},{"./app":1,"bootstrap-sass/assets/javascripts/bootstrap/collapse":5,"bootstrap-sass/assets/javascripts/bootstrap/dropdown":6,"jquery":10,"lazysizes/plugins/aspectratio/ls.aspectratio":12,"lazysizes/plugins/bgset/ls.bgset":13,"lazysizes/plugins/object-fit/ls.object-fit":14,"lazysizes/plugins/parent-fit/ls.parent-fit":15,"lazysizes/plugins/respimg/ls.respimg":16,"lazysizes/plugins/rias/ls.rias":17,"lodash/core":18}],4:[function(require,module,exports){
"use strict";
...
},{"./TweenLite.js":9}],9:[function(require,module,exports){
(function (global){
"use strict";
...
},{"lazysizes":11}],14:[function(require,module,exports){
(function(window, factory) {
	if(!window) {return;}
...
},{"lazysizes":11}],15:[function(require,module,exports){
(function(window, factory) {
	if(!window) {return;}
	var globalInstall = function(){
		factory(window.lazySizes);
...
},{"lazysizes":11}],16:[function(require,module,exports){
(function(window, factory) {
	if(!window) {return;}
	var globalInstall = function(){
		factory(window.lazySizes);
...
},{"lazysizes":11}],17:[function(require,module,exports){
(function(window, factory) {
	var globalInstall = function(){
		factory(window.lazySizes);
		window.removeEventListener('lazyunveilread', globalInstall, true);
...
},{"lazysizes":11}],18:[function(require,module,exports){
(function (global){
/**
 * @license

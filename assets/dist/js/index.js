...
var _joinRequest = _interopRequireDefault(require("./joinRequest"));
...
var App = {
  initialize: function initialize() {
    var page = _page["default"].initialize();

    _mobileMenu["default"].initialize(page);

    _joinRequest["default"].initialize(page);

    _modules["default"].sayHello();
...
var JoinRequest = {
  initialize: function initialize(page) {
    ...
    page.joinOpen = function (darkDrop) {
      ...
      if (darkDrop) {
        (0, _jquery["default"])('.join-request-backdrop').addClass('-dark');
      } else {
        (0, _jquery["default"])('.join-request-backdrop').removeClass('-dark');
      }

      join.find('.join-request-form').show();
      join.find('.join-request-message').hide();
      var tl = transitions.join.open(join);
      join.show();
      tl.play();
    };
    ...
    (0, _jquery["default"])(document).on('click', '.join-request-open', function (e) {
      e.preventDefault();
      page.joinOpen(true);
      return false;
    ...
    (0, _jquery["default"])('.join-request-form form').on('submit', function (e) {
      e.preventDefault();
      var self = (0, _jquery["default"])(_this);
      var $successContainer = self.find('.join-request-message.-success');
      var $errorContainer = self.find('.join-request-message.-error'); // $success_message = self.find('#join-movement-success');
      ...
      req.always(function () {
        ...
        (0, _jquery["default"])('.join-request-form').hide();
      });
    ...
    (0, _jquery["default"])('.join-request-message button').on('click', function () {
      page.joinClose();
    });
  }
};
...
},{"./transitions":5,"jquery":14}],3:[function(require,module,exports){
"use strict";
...
var MobileMenu = {
  initialize: function initialize(page) {
    page.mobileMenuIsOpen = false; //= = Open Mobile Menu Modal

    (0, _jquery["default"])(document).on('click', '.burger-button', function (e) {
      e.preventDefault();
    ...
    page.mobileMenuOpen = function (darkDrop) {
      var mobileMenu = (0, _jquery["default"])('.mobile-menu');
      var button = (0, _jquery["default"])('.burger-button');
      var $container = (0, _jquery["default"])('.mobile-menu-container');
      var iconClass = '.animated-menu-icon';
      var padding = page.calcNavHeight();
      button.find(iconClass).addClass('-active');
      $container.css('padding-top', padding);
      page.mobileMenuIsOpen = true;

      if (darkDrop) {
        (0, _jquery["default"])('.mobile-menu-backdrop').addClass('-dark');
      } else {
        (0, _jquery["default"])('.mobile-menu-backdrop').removeClass('-dark');
      }

      (0, _jquery["default"])('body').addClass('noScroll'); // mobileMenu.find('.request-form').show();
      // mobileMenu.find('.request-message').hide();

      var tl = transitions.mobileMenu.open(mobileMenu);
      mobileMenu.show();
      tl.play(); // YaStats
    ...
    page.mobileMenuClose = function () {
      var mobileMenu = (0, _jquery["default"])('.mobile-menu');
      var tl = transitions.mobileMenu.close(mobileMenu);
      (0, _jquery["default"])('body').removeClass('noScroll'); // Animate the close button
    ...
    (0, _jquery["default"])(document).on('click', '.mobile-menu-backdrop', function (e) {
      /* eslint-disable-next-line no-console */
      console.info('backdrop clicked', e);
      page.mobileMenuClose();
    });
    (0, _jquery["default"])(document).on('click', '.mobile-menu-close', function (e) {
      page.mobileMenuClose();
      e.preventDefault();
      return false;
    });
    (0, _jquery["default"])(document).on('click', '.mobile-menu-close-link', function (e) {
      page.mobileMenuClose();
      e.preventDefault();
      return false;
    });
...
},{"./transitions":5,"jquery":14}],4:[function(require,module,exports){
"use strict";
...
var Page = {
  initialize: function initialize() {
    ...
    var config = {
      calcNavHeight: {},
      root: (0, _jquery["default"])('html'),
      body: (0, _jquery["default"])('body'),
      content: (0, _jquery["default"])('.content')
    };

    var page = _objectSpread({}, config, {
      browser: {
    ...
    if (window) {
      var device = new _mobileDetect["default"](window.navigator.userAgent);
    ...
    page.calcNavHeight = function () {
      var navfixed = page.body.hasClass('navbar-is-fixed');
      var nh = page.navbar.outerHeight();
      var ah = page.brandNavbar.outerHeight();
      var calcHeight = nh;
    ...
    if (!page.browser.touch) {// Things for non mobile browsers
    }
    ...
    page.announcementBar = (0, _jquery["default"])('.announcement-bar');
    ...
    var scrollToClear = page.calcNavHeight(page.brandNavbar);
    /* eslint-disable-next-line no-unused-vars */

    var topOffset = page.navbar.outerHeight();
    var navResizeTime;
    (0, _jquery["default"])(window).resize(function () {
      clearTimeout(navResizeTime);
      navResizeTime = setTimeout(function () {
    ...
    var scrollPos = 0;
    var scrollTime; // NOTE:  Simple Navbar Scroll

    (0, _jquery["default"])(window).scroll(function () {
      clearTimeout(scrollTime); // const currentScroll = $(window).scrollTop();

      if ((0, _jquery["default"])(window).scrollTop() > scrollToClear) {
        page.navbar.addClass('navbar-fixed-top');

        _TweenLite["default"].to('#mainNav', 0.5, {
          y: 0
        });
      ...
      scrollTime = setTimeout(function () {
        scrollPos = (0, _jquery["default"])(window).scrollTop();
      }, 100);
    }); // Scroller

    page.skroller = (0, _jquery["default"])('.scroller');
    page.skroller.on('click', function () {
      var scrollOffset = 0;
      ...
      (0, _jquery["default"])('html, body').animate({
        scrollTop: (0, _jquery["default"])('#hero_end').offset().top - scrollOffset
      }, 1000);
    }); // Loader

    page.loader = (0, _jquery["default"])('.loader');
    page.loaderPromises = [];

    page.loaderHide = function () {
      var ldr = _this.loader;
      ldr.addClass('-hidden');
      setTimeout(function () {
        ldr.hide();
      }, 1700);
    ...
    page.loaderWatch = function () {
      ...
      _jquery["default"].when.apply(_jquery["default"], self.loaderPromises).done(function () {
        /* eslint-disable-next-line no-console */
        console.log('all items have loaded');
        (0, _jquery["default"])(document).trigger('allItems:loaded');
        self.loaderHide();
      });
    }; // Media Load
    ...
    page.mediaStart = function () {
      (0, _jquery["default"])('audio,video').each(function () {
        var loader = _jquery["default"].Deferred();
        ...
        video.load();
        self.on('canplaythrough error', function () {
          loader.resolve();
        });
      });
    };
    ...
    page.mediaRemove = function () {
      (0, _jquery["default"])('audio,video').empty().remove();
    }; // Preupdate handler
    // page.preUpdate = ()=> {
    //
    ...
    (0, _jquery["default"])(window).on('load', function () {
      page.wow = new _wowjs["default"].WOW({
        boxClass: 'wow',
...
var maxOverheat = false;
var transitions = {
  join: {
    open: function open(tween, vars) {
      var tl = new _TimelineLite["default"](_jquery["default"].extend(true, vars || {}, defaultVars));
    ...
    close: function close(tween, vars) {
      var tl = new _TimelineLite["default"](_jquery["default"].extend(true, vars || {}, defaultVars));
      tl.fromTo(tween.find('.join-request-backdrop'), 0.3, {
        opacity: 1
      }, {
...
},{"gsap/TimelineLite":12,"jquery":14}],6:[function(require,module,exports){
"use strict";
...
(0, _jquery["default"])(function () {
  ...
  */
  ...
  require('bootstrap-sass/assets/javascripts/bootstrap/collapse'); // eslint-disable-next-line global-require


  require('bootstrap-sass/assets/javascripts/bootstrap/dropdown'); // eslint-disable-next-line global-require
...
(0, _jquery["default"])(function () {
  ...
  var onYouTubeIframeAPIReady = function onYouTubeIframeAPIReady() {
    (0, _jquery["default"])('body').trigger('onYouTubeIframeAPIReady');
  };

  window.onYouTubeIframeAPIReady = onYouTubeIframeAPIReady;
  (0, _jquery["default"])('body').on('onYouTubeIframeAPIReady', function () {
    // eslint-disable-next-line no-console
    console.log('onYouTubeIframeAPIReady', 'ready');
  });
});

},{"./app":1,"bootstrap-sass/assets/javascripts/bootstrap/collapse":8,"bootstrap-sass/assets/javascripts/bootstrap/dropdown":9,"jquery":14,"lazysizes/plugins/aspectratio/ls.aspectratio":16,"lazysizes/plugins/bgset/ls.bgset":17,"lazysizes/plugins/object-fit/ls.object-fit":18,"lazysizes/plugins/parent-fit/ls.parent-fit":19,"lazysizes/plugins/respimg/ls.respimg":20,"lazysizes/plugins/rias/ls.rias":21}],7:[function(require,module,exports){
"use strict";
...
},{"./TweenLite.js":13}],13:[function(require,module,exports){
(function (global){
"use strict";
...
},{"lazysizes":15}],17:[function(require,module,exports){
(function(window, factory) {
	var globalInstall = function(){
		factory(window.lazySizes);
		window.removeEventListener('lazyunveilread', globalInstall, true);
...
},{"lazysizes":15}],18:[function(require,module,exports){
(function(window, factory) {
	if(!window) {return;}
...
},{"lazysizes":15}],19:[function(require,module,exports){
(function(window, factory) {
	if(!window) {return;}
	var globalInstall = function(){
		factory(window.lazySizes);
...
},{"lazysizes":15}],20:[function(require,module,exports){
(function(window, factory) {
	if(!window) {return;}
	var globalInstall = function(){
		factory(window.lazySizes);
...
},{"lazysizes":15}],21:[function(require,module,exports){
(function(window, factory) {
	var globalInstall = function(){
		factory(window.lazySizes);
		window.removeEventListener('lazyunveilread', globalInstall, true);
...
},{"lazysizes":15}],22:[function(require,module,exports){
